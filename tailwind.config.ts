...
export default {
  ...
  theme: {
  	extend: {
        ...
        'accent-2': { // Added accent-2
          DEFAULT: 'hsl(var(--accent-2))',
          foreground: 'hsl(var(--accent-2-foreground))'
        },
        'accent-3': { // Added accent-3
  		...
  		borderRadius: {
  			...
  			sm: 'calc(var(--radius) - 0.25rem)' // Slightly smaller than main radius
  		},
  		keyframes: {
  			'accordion-down': {
  				from: {
        ...
        'price-pulse': 'pricePulse 2s infinite ease-in-out',
  		}
  	}
  },
