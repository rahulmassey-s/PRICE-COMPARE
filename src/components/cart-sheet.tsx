    ...
    <>
      ...
      <Dialog open={showCollectionPopup} onOpenChange={setShowCollectionPopup}>
        <DialogContent className="max-w-md rounded-xl shadow-2xl">
          <DialogHeader>
            <DialogTitle>Minimum Booking Amount</DialogTitle>
          </DialogHeader>
          <div className="py-4 text-center text-base">
            Book minimum <span className="font-bold">₹350</span> for <span className="text-green-700 font-bold">free home collection</span>.<br />
            Or you can visit our collection center.<br />
            Otherwise, <span className="text-red-600 font-bold">₹100 collection charge</span> will apply.
          </div>
          <DialogFooter className="flex flex-col gap-2">
            <Button
              ...
              onClick={() => {
                ...
                setTimeout(() => handleProceedToBook(), 100);
              }}
            >
              Pay ₹100 Collection Charge (Home Collection)
            </Button>
            <Button
              variant="outline"
              className="w-full"
              onClick={handleVisitCollectionCenter}
            >
              I will visit Collection Center
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
